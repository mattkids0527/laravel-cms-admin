...
class AdminMenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $systemItems = [
            ['name' => '帳號管理', 'route_name' => 'admin.users.index',            'icon' => 'users',  'sort_order' => 1],
            ['name' => '角色管理', 'route_name' => 'admin.roles.index',            'icon' => 'shield', 'sort_order' => 2],
            ['name' => '選單權限', 'route_name' => 'admin.menu-permissions.index', 'icon' => 'menu',   'sort_order' => 3],
        ];
